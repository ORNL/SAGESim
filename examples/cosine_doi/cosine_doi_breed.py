...
from cosine_doi_step_func import step_func
...
class CosineDOIBreed(Breed):
    ...
    def __init__(self) -> None:
        ...
        # Register history
        self.register_property("infection_history", [])
        # Register the step function
        self.register_step_func(step_func, "cosine_doi_step_func.py", 0)
